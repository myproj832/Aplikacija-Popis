  ...
  return (
    <NavigationContainer>
      <Drawer.Navigator initialRouteName="Dobrodošlica">
        ...
        <Drawer.Screen name="Zalihe" component={ZaliheScreen} />

        {/* Sakriveno iz menija, ali dostupno za navigaciju */}
        <Drawer.Screen
          name="ArtikalDetalji"
          component={ArtikalDetaljiScreen}
          options={{ drawerItemStyle: { display: 'none' }, title: 'Detalji artikla' }}
        />
      </Drawer.Navigator>
    </NavigationContainer>
  );
